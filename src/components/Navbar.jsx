          ...
          <button
            ...
            className={`px-5 py-2 rounded-full font-semibold border transition ${
              scrolled
                ...
                : "bg-white/90 text-slate-900 border-transparent hover:bg-white hover:text-slate-800"
            }`}
            onClick={handleLogin}
            disabled={loggingIn}
          >
          ...
          <nav className="flex flex-col gap-3 text-sm">
            ...
            <div className="pt-2">
              {token ? (
                ...
                <button
                  type="button"
                  className={`w-full px-5 py-2 rounded-full font-semibold border transition ${
                    scrolled
                      ? "bg-slate-900 text-white border-slate-900 hover:bg-slate-800"
                      : "bg-white/90 text-slate-900 border-transparent hover:bg-white hover:text-slate-800"
                  }`}
